...
def setup_product():
    ...
    zcml.load_config('configure.zcml', uwosh.addcard)
    ...
    ztc.installPackage('uwosh.addcard')
...
setup_product()
ptc.setupPloneSite(products=['ATVocabularyManager', 'uwosh.addcard'])
# ptc.setupPloneSite()
ztc.installProduct('ATVocabularyManager')
ztc.installProduct('uwosh.addcard')
ptc.installProduct('ATVocabularyManager')
ptc.installProduct('uwosh.addcard')
